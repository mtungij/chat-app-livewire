<div x-data="{type:'all'}" class="flex flex-col transition-all h-full overflow-hidden">
    ...
    <main class="overflow-y-scroll overflow-hidden grow  h-full  relative" style="contain:content">
      ...
      <ul class="p-2 grid w-full space-y-2">
        ...
        <li class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-500/10 transition-colours duration-150  flex gap-4 relative w-full cursor-pointer px-2">
         <a href="http://" class="shrink-0">
            <x-avatar/>
        </a>
       
        <aside class="grid grid-cols-12 w-full">

             <a href="http://" class="col-span-11  border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5  w-full  flex-nowrap">
            {{-- name and date --}}
                <div class="flex justify-between  w-full items-center">
                    ...
                    <small class="text-gray-700">5minutes agoo</small>
                </div>
                  {{-- massage content --}}
...
{{-- 
                    ...
                    <p class="grow truncate text-sm font-[100]">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate est quod consequuntur, magni ipsum officiis error praesentium doloribus rerum deleniti inventore ratione fuga, beatae ea mollitia. Id culpa magnam ea.

                    </p>

                    {{-- unread count --}}

                    <span class="font-bold p-px px-2 text-xs shrink-0 rounded-full bg-blue-500  text-white">6</span>
