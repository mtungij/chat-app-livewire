<div class="fixed h-full flex bg-white border lg:shadow-sm overflow-hidden inset-0 lg:top-16 lg:inset-x-2 m-auto lg:h-[90%] rounded-lg">
    ...
    <div class="hidden md:visible md:block w-full border-l h-full relative overflow-y-auto" style="contain:content">
       <div class="flex justify-center items-center h-full">
          <h4 class="font-medium text-lg">Choose a conversion to start chatting</h4>
       </div>
    </div>
 </div>
